...
@Component({
  ...
  <section class="dash">
    ...
    <aside class="side">
      ...
      <nav class="menu">
        <a routerLink="agentes/nuevo" routerLinkActive="active">➕ Agregar agente</a>
        ...
        <a routerLink="eventos/nuevo" routerLinkActive="active">✍️ Nuevo Evento</a>
      
      <a routerLink="blog" routerLinkActive="active">📰 Artículos</a>

      <a routerLink="blog/nuevo" routerLinkActive="active">✍️ Nuevo artículo</a>
</nav>
    </aside>
...
export class AdminDashboardComponent {
  ...
  onActivate(e: any) {
  console.log('ACTIVATE CHILD:', e);
  this._hasChild.set(true);
}

onDeactivate() {
  console.log('DEACTIVATE CHILD');
  this._hasChild.set(false);
}
